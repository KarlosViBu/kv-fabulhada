...
export default function SummaryPage() {
   ...
   return (
      <ShopLayout title='Resumen de orden' pageDescription={'Resumen de la orden'}>
         <h1 className='titulo text-slate-100 m-3 md:y-5 md:mx-8'>Orden adadlald0-9-0345</h1>
         <span className='subtitulo text-white mx-10'>No pagada</span>
         <span className='subtitulo text-white mx-10'>Pagada</span>
